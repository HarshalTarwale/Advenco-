/**
 * Footer Component — Advenco Blinds & Shutters
 *
 * Matches the real WordPress site footer structure exactly:
 *  - Column 1: Logo, company description, social media links (Facebook,
 *    Instagram, Email)
 *  - Column 2: Quick Links (About Us, Privacy Policy, Terms & Conditions, Blogs)
 *  - Column 3: Blinds by Room (Bathroom, Bedroom, Kitchen, Dining Room,
 *    Living Room, Office)
 *  - Column 4: Contact Info (email, address, phone) + "Shop Online" button
 *
...
/* ---------- Footer Link Data (verbatim from the WordPress footer) ---------- */
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="space-y-5">
            ...
            <p className="text-white/50 text-sm leading-relaxed">
              Advenco Window Blinds and Shutters, your premier destination for
              high-quality window coverings in the UK.
            </p>
          ...
          {/* ---- Column 3: Blinds by Room ---------- */}
          <nav aria-label="Blinds by room navigation">
            <h3 className="text-xs font-light tracking-[0.2em] uppercase text-white/40 mb-5">
              Blinds by Room
            </h3>
            <ul className="space-y-3 list-none p-0 m-0">
              {blindsByRoomLinks.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-white/55 hover:text-white text-sm transition-colors"
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="flex items-start gap-2 text-white/55 text-sm">
                <svg className="w-4 h-4 shrink-0 mt-0.5" viewBox="0 0 384 512" fill="currentColor" aria-hidden="true">
                  <path d="M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192 192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z" />
                </svg>
                57 Queen Street Morley, Leeds LS27 8EB
              </p>
      ...
      <div className="border-t border-white/8">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/30 text-xs">
            Copyright &copy; {currentYear} Advenco Blind Sand Shutters | All rights reserved
          </p>
          <a
            href="#hero"
