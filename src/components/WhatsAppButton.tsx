/**
 * WhatsAppButton — Sitewide Floating Contact Button
 *
 * Fixed-position circular WhatsApp button, bottom-right on every page.
 * NOTE: number is a placeholder (sitewide phone number, no separators) —
 * swap WHATSAPP_NUMBER for the real WhatsApp business number when supplied.
 */

const WHATSAPP_NUMBER = "448000541880"; // placeholder — replace with real WhatsApp number
...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] shadow-lg transition-colors">
